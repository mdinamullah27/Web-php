...
<body>
	<div class="container" style="margin-top:20px;">
		<div class="jumbotron">
			<h1 style="align:middle;color:blueviolet">LAB REPORT ONE</h1>
			<p>The code written by <b style="color:brown;">Inam </b> with html, css, boostrap, php and mysql with responsive design</p>
		</div>
		<table class="table">
			<thead>
				<tr>
